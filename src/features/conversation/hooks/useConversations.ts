...
import { conversationApi, CONVERSATION_POLL_INTERVAL_MS } from "../api/conversationApi";
...
export function useCreateDirectConversation() {
  return useMutation({
    mutationFn: (otherUserId: string) => conversationApi.createDirectConversation(otherUserId),
  });
}
